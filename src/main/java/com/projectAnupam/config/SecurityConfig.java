package com.projectAnupam.config;

import com.projectAnupam.security.filter.JwtAuthenticationFilter;
...
//                        .requestMatchers("/student-dashboard.html").hasRole("STUDENT")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:8080", "http://localhost:3000", "http://localhost:63342"));
